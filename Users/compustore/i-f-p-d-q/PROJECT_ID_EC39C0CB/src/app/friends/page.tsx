...
import { Search, Loader2, CheckCircle, MessageSquare, User } from 'lucide-react';
              ...
              <div className="flex justify-center items-center h-48">
                ...
                <div className="space-y-1">
                    {filteredFriends.map((friend) => (
                        <div key={friend.id} className="flex items-center space-x-4 p-2 hover:bg-muted/50 transition-colors rounded-lg">
                            <Link href={`/profile?id=${friend.id}`} className="flex flex-1 items-center space-x-4 min-w-0">
